...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout id="Header" style="width: 100%; flex-grow: 1; flex-shrink: 1; background-color: height: 17.5%; background-color: var(--lumo-contrast-20pct); align-self: center; align-items: stretch; min-height: auto; flex-grow: 1; min-width: 100%; flex-direction: column; justify-content: center;" class="header"></vaadin-horizontal-layout>
