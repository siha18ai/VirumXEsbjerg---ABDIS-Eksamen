...
import com.gmail.simon.ui.views.medarbejderView.*;
...
public class MedarbejderLayout extends FlexBoxLayout
        implements RouterLayout, PageConfigurator, AfterNavigationObserver {

    private static final Logger log = LoggerFactory.getLogger(MedarbejderLayout.class);
    ...
    private void initNaviItems() {
        ...
        menu.addNaviItem(VaadinIcon.NEWSPAPER, "Artikler", ArtiklerView.class);
        menu.addNaviItem(VaadinIcon.PAPERCLIP, "Ordrer", OrdreView.class);
    }
    ...
    public static MedarbejderLayout get() {
        return (MedarbejderLayout) UI.getCurrent().getChildren()
                .filter(component -> component.getClass() == MedarbejderLayout.class)
                .findFirst().get();
    }
